...
describe('Default calculation', () => {
    ...
    it('targetDoughWeight = 540', () => expect(calc().targetDoughWeight).toBe(540));
    ...
    it('finalDoughWeight ≈ 540', () => expect(approx(calc().finalDoughWeight, 540, 2)).toBe(true));
    it('actualPerBall ≈ 90', () => expect(approx(calc().actualPerBall, 90, 1)).toBe(true));
...
describe('Yeast type conversions', () => {
    ...
    it('swedishDry label', () =>
        expect(calc({ yeastType: 'swedishDry' }).yeastTypeLabel).toBe('Swedish dry yeast'));
...
describe('Sugar and oil', () => {
    it('sugarToAdd > 0 (default 2%)', () => expect(calc().sugarToAdd).toBeGreaterThan(0));
    it('oilToAdd > 0 (default 2%)', () => expect(calc().oilToAdd).toBeGreaterThan(0));
...
describe('Zero starter', () => {
    ...
    it('dough weight still ≈ 540', () => {
        expect(approx(calc({ starterWeight: 0 }).finalDoughWeight, 540, 2)).toBe(true);
    });
});
...
describe('Edge cases', () => {
    ...
    it('24h: bulk clamped to 360', () => expect(calc({ totalHours: 24 }).bulkMinutes).toBe(360));
    it('24h: proof >= 50', () =>
        expect(calc({ totalHours: 24 }).finalProofMinutes).toBeGreaterThanOrEqual(50));
    it('24h: proof <= 180', () =>
        expect(calc({ totalHours: 24 }).finalProofMinutes).toBeLessThanOrEqual(180));
