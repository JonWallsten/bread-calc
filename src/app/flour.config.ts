...
export const FLOUR_DEFINITIONS: FlourDefinition[] = [
  ...
  },
  {
    ...
    notesSv:
      "Rustikt mjöl som ofta känns torrt tidigt och gynnas av något högre hydrering.",
  },
  {
    id: "strong_bread",
  ...
  },
  {
    ...
    hydrationBias: 0,
    notesEn:
      "Fine Italian flour. Neutral hydration baseline, good for pizza and soft breads.",
    notesSv:
      "Fint italienskt mjöl. Neutral hydreringsbaslinje, bra för pizza och mjuka bröd.",
  },
  {
    id: "sifted_spelt",
    nameEn: "Sifted spelt",
    ...
    hydrationBias: -1.0,
    notesEn:
      "Weaker gluten than wheat. Tends to absorb less water, handle gently.",
    notesSv:
  ...
  },
  {
    ...
    hydrationBias: 2.0,
    notesEn:
      "High absorption, sticky dough. Best as a portion of the total flour.",
    notesSv:
      "Hög absorption, kladdig deg. Bäst som en del av det totala mjölet.",
  },
  {
    id: "rye_flour",
    nameEn: "Rye flour",
    ...
    hydrationBias: 3.0,
    notesEn:
      "Very high absorption. Use in smaller amounts unless making a rye-heavy bread.",
    notesSv:
...
export function getFlourDefinitionById(
  id: string,
): FlourDefinition | undefined {
